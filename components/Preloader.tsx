...
const Preloader: React.FC = () => {
  ...
  return (
    <div className="flex items-center justify-center h-screen bg-black text-white">
      <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-extrabold tracking-widest text-gray-200 animate-none transition-transform transform hover:scale-105">
