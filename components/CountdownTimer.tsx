...
const CountdownTimer: React.FC = () => {
  const calculateTimeLeft = (): TimeLeft => {
    ...
    const targetDate = new Date("2024-11-05T23:59:59+05:30");
    const now = new Date();
  ...
  return (
    <div className=" border-2 border-neutral-400 p-4 rounded-xl border-solid mx-12 md:mx-96 text-center text-lg md:text-4xl font-bold text-neutral-400">
      <div>
